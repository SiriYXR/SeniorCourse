...
&emsp;&emsp;该课程将会先教授大家最基础的C语言语法，然后以C语言开发一个控制台版推箱子游戏为主线，围绕该主线讲解使用到的C语言相关语法知识，以及一些拓展内容。带领大家从零基础学习C语言语法、开发软件使用、程序项目设计开发。后期还会教授大家学习使用一个图形库，开发界面色彩丰富，更为酷炫的程序软件。
