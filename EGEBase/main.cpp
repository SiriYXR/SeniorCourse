...
int main() {
	...
	while (true) {
		...
		cout << "样例程序" << endl;
		cout << "------------------------------------------------------------------------------------------------------------------------" << endl;
		cout << "30\t样例程序一：五角星" << endl;
		cout << "31\t样例程序二：箭头" << endl;
		cout << "32\t样例程序三：弹球1" << endl;
		cout << "33\t样例程序四：烟花" << endl;
		cout << "34\t样例程序五：时钟" << endl;
		cout << "35\t样例程序六：弹球2" << endl;
		cout << "36\t样例程序七：线条屏保" << endl;
		cout << "37\t样例程序八：弹球3" << endl;
		cout << "38\t样例程序九：鼠标点击测试" << endl;
		cout << "39\t样例程序十：碧波荡漾" << endl;
		cout << "40\t样例程序十一：贪吃蛇" << endl;
		cout << "41\t样例程序十二：俄罗斯方块" << endl;
		cout << "42\t样例程序十三：渐变三角形屏保" << endl;
		cout << "43\t样例程序十四：字母掉落" << endl;
		cout << "------------------------------------------------------------------------------------------------------------------------" << endl;
		cout << "99\t退出" << endl;
		cout << "------------------------------------------------------------------------------------------------------------------------" << endl;
		cout << "请输入要执行示例的编号:" ;
